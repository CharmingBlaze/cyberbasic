...
public:
    ...
    GuiColor get_text_color() const { return textColor; }
    GuiColor get_background_color() const { return backgroundColor; }
    GuiColor get_border_color() const { return borderColor; }
    ...
    void set_text_color(const GuiColor& color) { textColor = color; }
    void set_background_color(const GuiColor& color) { backgroundColor = color; }
    void set_border_color(const GuiColor& color) { borderColor = color; }
